...
When an area of the dungeon is cleared of threats, there is a 1 in 6 chance per day that a group of 1HD creatures or other scavengers will fill the void. Once a “season” the Judge should re-populate the vacated areas with appropriate strength monsters as for a new dungeon.

## Trap Types
When stocking a dungeon, there is a 1 in 6 chance for a room to have a trap.  To determine the type of trap, compare the depth level of the dungeon level against a d6 roll on the table below.  This will give you the “Threat” rank (I – VI) of the trap.
...
## Trap Descriptions
Searching has a base 2 in 6 chance to spot a trap, and there is a base 2 in 6 chance (per creature) to trigger a trap. The Judge may rule that a trap resets in 1d6 minutes.
...
**Pit; Covered**: As described above, victims must save vs. stone to avoid falling damage as described above.
...
Within a dungeon, there is a 2 in 6 chance a monster is present in any un-allocated space. To determine the type of monster encountered, compare the depth level of the dungeon level against a d6 roll on the table below.  This will give you the “Threat” rank (I – VI) of the monster; a range of (equivalent) Hit Dice to select the Monster from (see Monsters below).
...
For a more detailed list of appropriate monsters and Equivalent Hit Dice, consult the [OED Monster Stat Blocks add-on]([http://oedgames.com/addons/houserules/OED-MonsterDetermination.pdf](http://www.oedgames.com/addons/houserules/OED-MonsterStatBlocks-1.1.4.pdf))
sheet.

## Number Appearing

When stocking a dungeon, the numbers of monsters appearing is dependent on the relation between the Equivalent Hit Die of the creature and dungeon level/depth (presuming a traditional party of 4). You can add a +1 to the d4 roll for every two additional party members.
